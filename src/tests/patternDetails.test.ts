...
const getPatternInfo = (patternName: string, direction: string = "bullish") => {
...
// Test functions
export const testAllPatternsHaveDetails = () => {
  const missingPatterns: string[] = [];
  const patternsWithDetails: string[] = [];
...
export const testPatternDetailStructure = () => {
...
const detailsTest = testAllPatternsHaveDetails();
...
const structureTest = testPatternDetailStructure();
...
export { ALL_PATTERNS, CANDLESTICK_PATTERNS, VOLUME_PATTERNS, HARMONIC_PATTERNS, STATISTICAL_PATTERNS, CHART_PATTERNS };